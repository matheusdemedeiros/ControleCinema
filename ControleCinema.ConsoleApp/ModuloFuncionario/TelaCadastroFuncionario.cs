...
namespace ControleCinema.ConsoleApp.ModuloFuncionario
{
    public class TelaCadastroFuncionario : TelaBase, ITelaCadastravel
    {
        ...
        public void EditarRegistro()
        {
            ...
            bool conseguiuEditar = _repositorioFuncionario.Editar(x => x.id == numeroFuncionario, funcionarioAtualizado);
        ...
        public void ExcluirRegistro()
        {
            ...
            bool conseguiuExcluir = _repositorioFuncionario.Excluir(x => x.id == numeroFuncionario);
        ...
        public int ObterNumeroRegistro()
        {
            ...
            do
            {
                ...
                numeroRegistroEncontrado = _repositorioFuncionario.ExisteRegistro(x => x.id == numeroRegistro);
